...
event STUN::STUNPacket(c: connection, is_orig: bool, method: count, class: count, trans_id: string)
	{
	print "STUN Packet", c$id$orig_h, c$id$orig_p, c$id$resp_h, c$id$resp_p, is_orig, method, class, trans_id;
	}
...
event STUN::string_attribute(c: connection, is_orig: bool, method: count, class: count, trans_id: string,
	...
	{
	print "String Attr", c$id$orig_h, c$id$orig_p, c$id$resp_h, c$id$resp_p, is_orig, method, class, trans_id, attr_type, attr_val;
	}
...
event STUN::mapped_address_attribute(c: connection, is_orig: bool, method: count, class: count,
	...
	{
	print "Mapped Addr Attr", c$id$orig_h, c$id$orig_p, c$id$resp_h, c$id$resp_p, is_orig, method, class, trans_id, attr_type, x_port, x_addr;
	}
...
event STUN::error_code_attribute(c: connection, is_orig: bool, method: count, class: count, trans_id: string,
	...
	{
	print "Error Code Attr", c$id$orig_h, c$id$orig_p, c$id$resp_h, c$id$resp_p, is_orig, method, class, trans_id, attr_type, err_class, number, reason;
	}
